 ...
 * @author <a href="http://www.leshazlewood.com">Les Hazlewood</a>
 */
public class EmailAddress implements Serializable {
	 ...
	 */
	private static final long serialVersionUID = 7232955439301997387L;
    ...
    public static String findFromInput(String input) {
    	Matcher m = VALID_PATTERN.matcher(input);
    	if (m.find())
    		return m.group();
    	else
    		return "";
